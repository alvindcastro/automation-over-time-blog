...
Starting fresh was not a rejection of the earlier work. It was an acknowledgment that the problem space had changed. The next iteration needed to survive future change, not just accommodate the current system.

This reset came with different priorities:
